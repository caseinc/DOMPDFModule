...
return array(
    'dompdf_module' => array(
         ...
         * *Please note the trailing slash.*
         */
        'font_directory' => __DIR__ . '/../../../caseinc/dompdf/lib/fonts/',
         ...
         */
        'font_cache_directory' => __DIR__ . '/../../../caseinc/dompdf/lib/fonts/',
         ...
         */
        'chroot' => realpath(__DIR__ . '/../../../caseinc/dompdf/'),
         ...
         * @var string
         */
        'log_output_file' => __DIR__ . '/../../data/caseinc-dompdf/log',
